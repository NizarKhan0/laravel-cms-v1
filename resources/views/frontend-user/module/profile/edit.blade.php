            ...
            <form method="POST" action="{{ route('user.profile.update') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="username" name="username" type="text" value="{{ old('username', $user->username) }}"
                        required class="w-full rounded-xl border border-zinc-300 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-zinc-700 mb-1" for="password">New Password (optional)</label>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <a href="{{ route('user.dashboard') }}" class="px-4 py-2.5 rounded-xl border border-zinc-300 text-zinc-700 hover:bg-zinc-50">
                        Back
                    </a>
