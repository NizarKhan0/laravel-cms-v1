                                    ...
                                    <thead>
                                        <tr class="border-b border-gray-100 dark:border-gray-800">
                                            <th class="px-5 py-3 text-left">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">No</span>
                                            </th>
                                            <th class="px-5 py-3 text-left">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Username</span>
                                            </th>
                                            <th class="px-5 py-3 text-left">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Email</span>
                                            </th>
                                            <th class="px-5 py-3 text-left">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Full Name</span>
                                            </th>
                                            <th class="px-5 py-3 text-left">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Created At</span>
                                            </th>
                                            <th class="px-5 py-3 text-right">
                                                <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Actions</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <!-- Table Body -->
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                        @forelse($frontendUsers as $user)
                                            <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                                <td class="px-5 py-4">
                                                    <span class="block text-sm font-medium text-gray-800 dark:text-white/90">{{ $loop->iteration }}</span>
                                                </td>
                                                <td class="px-5 py-4">
                                                    <span class="block text-sm text-gray-600 dark:text-gray-400">{{ $user->username }}</span>
                                                </td>
                                                <td class="px-5 py-4">
                                                    <span class="block text-sm text-gray-600 dark:text-gray-400">{{ $user->email }}</span>
                                                </td>
                                                <td class="px-5 py-4">
                                                    ...
                                                    <div class="flex items-center justify-end gap-2">
                                                        ...
                                                        <a href="{{ route('frontend-user.show', $user->id) }}"
                                                            ...
                                                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 4.5C5.5 4.5 2.5 6.5 1 9C2.5 11.5 5.5 13.5 9 13.5C12.5 13.5 15.5 11.5 17 9C15.5 6.5 12.5 4.5 9 4.5ZM9 12C7.5 12 6.5 11 6.5 9.5C6.5 8 7.5 7 9 7C10.5 7 11.5 8 11.5 9.5C11.5 11 10.5 12 9 12Z" fill=""></path>
                                                            </svg>
                                                        </a>
                                                        <!-- Edit Button -->
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="{{ route('frontend-user.destroy', $user->id) }}" method="POST" class="inline delete-form">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                            ...
                                            <tr>
                                                <td colspan="6" class="px-5 py-12 text-center">
                                                    <div class="mx-auto max-w-md">
                                                        <h4 class="mb-1 text-base font-medium text-gray-700 dark:text-gray-300">No users found</h4>
                                                        <p class="text-sm text-gray-500 dark:text-gray-500">
                                                            Click the "Create New User" button to add your first frontend user.
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
